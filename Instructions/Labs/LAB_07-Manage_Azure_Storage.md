...
1. InPrivate 모드를 사용하여 다른 브라우저 창을 열고 이전 단계에서 복사한 URL로 이동합니다.
    ...
    > **참고**: 파일을 다운로드하고 메모장에서 열어 파일의 내용을 볼 수 있어야 합니다.
...
1. 새로 만든 파일 공유를 클릭하고 **az104-07-share** 블레이드에서 사용할 수 있는 정보를 확인합니다.
...
1. **az104-07-share \| 파일 공유 찾아보기** 블레이드로 돌아가**서 새로 고침**을 클릭하고 **az104-07-folder**가 폴더 목록에 표시되는지 확인합니다.
