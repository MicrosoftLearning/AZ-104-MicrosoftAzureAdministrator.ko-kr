...
>**참고**: **원시 오류** 탭을 클릭하면 역할 정의의 이름인 **기본값이 포함된 비용 센터 태그 필요**를 포함하여 오류에 대한 자세한 내용을 확인할 수 있습니다. 만들려는 스토리지 계정에 값이 **기본값**으로 설정된 **비용 센터**라는 태그가 없기 때문에 배포에 실패했습니다.
