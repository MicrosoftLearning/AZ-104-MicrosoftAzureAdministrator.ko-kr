...
1. 모든 **10.20.0.0/16**을 `10.30.0.0/16`으로 바꿉니다. 
...
### 네트워크 보안 그룹을 만들고 이를 ASG 서브넷과 연결합니다.
...
1. **+ 가상 네트워크 링크**를 선택한 다음 **+ 추가**를 선택합니다. 
...
1. **확인**을 선택하고 링크가 만들어질 때까지 기다립니다. 
