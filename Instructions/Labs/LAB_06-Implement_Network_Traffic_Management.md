...
1. **진단 테스트 실행**을 클릭하고 연결 확인 결과가 반환될 때까지 기다립니다. 상태가 **성공**인지 확인합니다. 네트워크 경로를 검토하고 트래픽이 **10.60.0.4**를 통해 라우팅되고 **az104-06-nic0** 네트워크 어댑터에 할당되어있습니다. 상태 **실패**인 경우 중지한 다음 az104-06-vm0을 시작해야 합니다.
