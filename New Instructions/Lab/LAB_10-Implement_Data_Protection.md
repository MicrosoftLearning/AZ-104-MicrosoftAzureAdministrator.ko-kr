...
조직에서 Azure 가상 머신의 백업 및 복원을 위해 Azure Recovery Services를 평가하고 있습니다. 조직은 우발적이거나 악의적인 데이터 손실로부터 데이터를 보호하는 방법을 식별하기 위해 노력하고 있습니다.
...
1. 필요한 경우 Allfiles Labs\\10 az104-10-vms-edge-template.json**\\ 랩 파일을 다운로드**\\합니다.\\
...
2. 
   >**참고:** 잠시 템플릿을 검토하세요. 배포 중인 가상 머신 및 가상 네트워크는 몇 대인가요? 

1. **저장**을 선택합니다.
 
   >**참고:** 이 템플릿에는 관리자가 변경할 수 있는 매개 변수가 많이 있습니다. 
...
이 작업에서는 Recovery Services 자격 증명 모음을 만듭니다. Recovery Services 자격 증명 모음은 Azure 가상 머신에 대한 백업 데이터를 제공합니다.
